...
public class Controller
{
		...
		if (this.verifMDP(cs0)) 
		{
			if (Arrays.equals(cs1, cs2)) 
			{
				...
				JOptionPane.showMessageDialog(null,
						"Mot de passe chang� avec succ�s ! Vous allez �tre redirig� vers l'�cran d'accueil.", "Information",
	...
	public void bouteilleFinie() 
	{
		...
		JOptionPane.showMessageDialog(null,
				"Le changement a bien �t� enregistr�.", "Information",
				JOptionPane.INFORMATION_MESSAGE);
	}
	...
	public void associerGoulot(String boisson)
	{
		...
		JOptionPane.showMessageDialog(null,
				"Le goulot a bien �t� associ�. Vous allez �tre redirig� vers l'�cran d'accueil.", "Information",
				JOptionPane.INFORMATION_MESSAGE);
